...
- For Android open `native/androidTest` in AndroidStudio navigate to `app/src/androidTest/java/com.nitromelondb.test/BridgeTest` and click green arrow near `class BridgeTest`
