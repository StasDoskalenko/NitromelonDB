...
The app links the library via `file:../..`. Metro watches `src/` plus WatermelonDB JS dependencies (`rxjs`, `sql-escape-string`, `rambdax`, …) so those imports resolve outside the example tree.
