...
Expo SDK 57 web workers require bundle splitting. Expo Router already provides the runtime; projects without Router should install `@expo/metro-runtime` and import it once from the entry file:
