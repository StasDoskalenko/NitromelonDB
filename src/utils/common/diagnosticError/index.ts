export type DiagnosticErrorFunction = (arg0: string) => Error;
...
export function useCustomDiagnosticErrorFunction(diagnosticErrorFunction: DiagnosticErrorFunction): void {
